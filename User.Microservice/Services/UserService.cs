...
namespace User.Microservice.Services
{
    public class UserService : IUserService
    {
        ...
        private UserModel getUserByRefreshToken(string token)
        {
        ...
        private void revokeDescendantRefreshTokens(RefreshToken refreshToken, UserModel user, string ipAddress, string reason)
        {
